...
export default function Hero() {
  return (
    <header className="grid grid-cols-1 md:grid-cols-2 mt-2 mx-auto items-center min-h-screen justify-center gap-10 ext-black text-left p-10 w-full mb-20">
        <div className="col-span-1 flex flex-col sm:mt-2 text-center mx-auto items-left justify-center">
            <h1 className="text-5xl font-bold text-left sm:mt-2 ">Hi there! I'm Conner</h1>
